                    ...
                    <div class="eventRegisterContainer" id="register-event">
                        ...
                        @csrf
                            ...
                            <div class="infoContainer  col-12">
                                <div class="col-8">
                                    ...
                                    <div class="d-flex gap-1 col-12">
                                        <div class="dateTimeEventContainer borderContainer col-6">
                                            <div class="borderBody col-12">
                                        ...
                                        <div class="col-6 invitados borderContainer">
                                ...
                                <div class="col-4 my-2">
                                    <div>
                                        <div class="mb-4 d-flex justify-content-center">
                                            <img onclick="document.getElementById('regBtnEventImg').click();" name="regEventImg" id="regEventImg" src="https://placehold.co/300x200?text=Imagen+del+evento&font=roboto" alt="example placeholder" style="object-fit: contain;overflow: auto;"/>
                            ...
                            <div class="col-12 my-2" style="text-align:center;">
                                ...
                                <div class="row mt-3">
                                    <div class="col-4 mx-auto" style="text-align-last: end">
