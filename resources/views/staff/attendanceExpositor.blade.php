...
<div class="expositor-w justify-content-center mt-4 flex-wrap titleEvent">
    <h1 class="text-center col-12" style="font-size: 2rem; margin-bottom:20px; margin-top:20px; color:white">EXPOSITOR</h1>
